              ...
              <div className="contact-form-desgin">
                ...
                <form>
                  <div className="contact-form">
                    <label className='form-labek'>Name</label>
                    <input type="text" className='form-control' />
                  </div>
                  <div className="contact-form">
                    <label className='form-labek'>E-mail</label>
                    <input type="text" className='form-control' />
                  </div>
                  <div className="contact-form">
                    <label className='form-labek'>Service yoo need</label>
                  ...
                  <div className="contact-form">
                    <label className='form-labek'>Yore Message</label>
